...
_این مستندات با اجرای فرمان زیر از روی کد منبع تولید شده است:_

```bash
clojure -M:ee:doc environment-variables-documentation
```

بسیاری از تنظیمات متابیس را می‌توان در پنل مدیر دید و تغییر داد یا از طریق متغیرهای محیطی تنظیم کرد. متغیرهای محیطی همیشه نسبت به تنظیمات پنل مدیر در اولویت هستند. توجه کنید که بر خلاف تنظیماتی که در Admin settings ثبت می‌شوند، مقدار متغیرهای محیطی در پایگاه‌دادهٔ برنامه ذخیره نمی‌شود.

## نحوهٔ تنظیم متغیرهای محیطی

بسته به این‌که متابیس را چطور اجرا می‌کنید، روش‌های مختلفی برای تنظیم متغیرهای محیطی وجود دارد.

اجرای فایل JAR:

```bash
# روی Mac، لینوکس و سیستم‌های مبتنی بر یونیکس
export MB_SITE_NAME="Awesome Company"
# روی Windows Powershell
$env:MB_SITE_NAME="Awesome Company"
# روی Windows batch/cmd
set MB_SITE_NAME="Awesome Company"

java --add-opens java.base/java.nio=ALL-UNNAMED -jar metabase.jar
```

یا می‌توانید آن را به‌صورت خاصیت جاوا تنظیم کنید؛ روشی که در همهٔ سیستم‌ها یکسان کار می‌کند:
...
## متغیرهای محیطی در Metabase Cloud

اگر متابیس را روی Metabase Cloud اجرا می‌کنید، می‌توانید برای تنظیم متغیرهای محیطی با [پشتیبانی](https://www.metabase.com/help-premium) در ارتباط باشید.
