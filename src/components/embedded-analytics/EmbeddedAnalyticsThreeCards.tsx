...
const EmbeddedAnalyticsThreeCards: React.FC = () => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div className="bg-white border border-metabase-border-light rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h4 className="text-xl font-bold text-metabase-text-primary mb-3">
              راه‌اندازی راه‌حل تجزیه و تحلیل تعبیه شده خود را در 5 دقیقه
            </h4>
            <p className="text-metabase-text-secondary">
              راه‌اندازی با یک workflow ساده - بدون نیاز به توسعه‌دهندگان یا
              مهارت‌های فنی تخصصی. با هر چیزی که در ابزارهای داده و برنامه‌های
              کسب و کار مورد علاقه شما وجود دارد کار می‌کند.
            </p>
          </div>
          ...
          <div className="bg-white border border-metabase-border-light rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-metabase-text-secondary">
              ...
              می‌دهد. در منطقه نزدیک به شما میزبانی می‌شود تا BI تعبیه شده شما
              نزدیک باشد.
            </p>
          </div>
          ...
          <div className="bg-white border border-metabase-border-light rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h4 className="text-xl font-bold text-metabase-text-primary mb-3">
              مطابق با SOC 2 Type II
            </h4>
            <p className="text-metabase-text-secondary">
              انطباق سطح سازمانی بدون تیک‌زدن جعبه. مشتریان خود را به سمت
              تصمیم‌گیری مبتنی بر داده در شرایط خود هدایت کنید.
            </p>
          </div>
        </div>
      </div>
...
export default EmbeddedAnalyticsThreeCards;
