...
const EmbeddedAnalyticsFooter: React.FC = () => {
  return (
    <div className="bg-gradient-to-b from-blue-50 to-white py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-3xl md:text-4xl font-bold text-metabase-text-primary mb-6">
            آماده شروع هستید؟
          </h3>
          <p className="text-lg text-metabase-text-secondary mb-8">
            در 5 دقیقه با یک دوره آزمایشی رایگان 14 روزه راه‌اندازی شوید. یا با
            تیم ما تماس بگیرید تا با یک متخصص صحبت کنید.
          </p>
          ...
          <div className="mt-12">
            <Image
              src="/images/product/embedded-analytics/slanted-screenshot.png"
...
export default EmbeddedAnalyticsFooter;
