...
const MetabaseVsDomoHero: React.FC = () => {
  return (
    <div className="bg-white py-12 md:py-20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative w-full aspect-video rounded-lg overflow-hidden shadow-lg border border-metabase-border-light">
            <iframe
              width="100%"
              height="100%"
              src="https://www.youtube.com/embed/OK-eq5obu3o"
...
export default MetabaseVsDomoHero;
