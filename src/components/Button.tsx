...
const Button: React.FC<ButtonProps> = ({
  ...
  // Base styles
  const baseStyles =
    "inline-flex items-center justify-center font-bold rounded-lg transition-colors duration-200 focus:outline-none focus:ring-4 focus:ring-blue-300 disabled:opacity-50 disabled:cursor-not-allowed";

  // Variant styles using Metabase brand colors
  const variantStyles = {
    primary:
      "bg-metabase-primary text-white hover:bg-metabase-primary-dark focus:ring-metabase-primary",
    secondary:
      "bg-metabase-text-secondary text-white hover:bg-metabase-primary-darker focus:ring-metabase-primary",
    outline:
      "border-2 border-metabase-primary text-metabase-primary hover:bg-metabase-bg-light focus:ring-metabase-primary",
    ghost:
