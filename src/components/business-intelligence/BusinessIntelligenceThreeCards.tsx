...
const BusinessIntelligenceThreeCards: React.FC = () => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div className="bg-white border border-metabase-border-light rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-metabase-text-secondary">
              ...
              وجود دارد با تعدادی اتصال‌دهنده داده ساده کار می‌کند.
            </p>
          </div>
          ...
          <div className="bg-white border border-metabase-border-light rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-metabase-text-secondary">
              انطباق سطح سازمانی، توانمندسازی تصمیم‌گیری‌های سطح سازمانی. بدون
              تیک‌زدن جعبه، یا برچسب قیمت سازمانی.
            </p>
          </div>
        </div>
      </div>
...
export default BusinessIntelligenceThreeCards;
