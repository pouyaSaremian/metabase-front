    ...
    <>
      ...
      <div>
        ...
        <FeatureSection
          ...
          items={[
            {
              text: "سازنده‌ی کوئریی بصری با قابلیت کشیدن و رها کردن که به هم‌تیمی‌های کمتر داده‌محور اجازه می‌دهد سوالات خود را بدون نیاز به SQL (یا تیم داده برای کمک به آنها) جمع‌آوری کنند. آنها حتی Excel را از دست نخواهند داد.",
              bold: true,
            },
            {
